	...
	public  String rutaArchivo(){
		...
		try {
			...
			if(nomdia.equals("lun")){
				carpeta = "//Servidor/d/ProyectoCEL/File/Speach/proveedor/lunes";
			}else if(nomdia.equals("mar")){
				carpeta = "//Servidor/d/ProyectoCEL/File/Speach/proveedor/martes";
			}else if(nomdia.equals("mié")){
				carpeta = "//Servidor/d/ProyectoCEL/File/Speach/proveedor/miercoles";
			}else if(nomdia.equals("jue")){
				carpeta = "//Servidor/d/ProyectoCEL/File/Speach/proveedor/jueves";
			}else if(nomdia.equals("vie")){
				carpeta = "//Servidor/d/ProyectoCEL/File/Speach/proveedor/viernes";
			}else if(nomdia.equals("sáb")){
				carpeta = "//Servidor/d/ProyectoCEL/File/Speach/proveedor/sabado";
			}else{
				carpeta = "";
			}
