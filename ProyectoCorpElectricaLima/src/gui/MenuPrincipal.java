...
//			mniLook1.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==jMenuItem10){
			...
			try {obj16.setSelected(true);
			} catch (java.beans.PropertyVetoException e2) {}
		}
		if(e.getSource()==jMenuItem5){
			/*if(obj17==null||obj17.isClosed()){
				obj17= new MantProdAlt();
				jDesktopPane1.add(obj17);
				System.out.println("ENTRA A EL JMENU ITEM5");
				}
			try {obj17.setSelected(true);
			} catch (java.beans.PropertyVetoException e2) {}*/
		}
		...
		if(e.getSource()==mniBuscarProducto){
			...
			try {objBuscarProducto.setSelected(true);
			} catch (java.beans.PropertyVetoException e2) {}
		}
		if(e.getSource()==mniBuscarProveedor){
			...
			try {objBuscarProveedor.setSelected(true);
			} catch (java.beans.PropertyVetoException e2) {}
		}
		if(e.getSource()==mniMasivo){
			if(objEnviarCorreoMasivo==null||objEnviarCorreoMasivo.isClosed()){
				//objGUI.mostrarAviso("En Construccion.....!!");
				objEnviarCorreoMasivo= new EnvioCorreoMasivo();
				jDesktopPane1.add(objEnviarCorreoMasivo);
				}
			try {objEnviarCorreoMasivo.setSelected(true);
			} catch (java.beans.PropertyVetoException e2) {}
		}
		///////////////////////////////
		...
		if(e.getSource()==mniUmedAlt){
			...
			try {objUmedAlt.setSelected(true);
			} catch (java.beans.PropertyVetoException e2) {}
		}
		
		if(e.getSource()==mniConfigurar){
			if(objconfigurarTuCuenta==null||objconfigurarTuCuenta.isClosed()){
			...
			try {objconfigurarTuCuenta.setSelected(true);
			} catch (java.beans.PropertyVetoException e2) {}
		}
		if(e.getSource()==mnuiGenerarOrdenCompra){
			if(objGenerarOrdenCompra==null||objGenerarOrdenCompra.isClosed()){
				//objGUI.mostrarAviso("En Construccion.....!!");
			...
			try {objGenerarOrdenCompra.setVisible(true);
		...
		if(e.getSource()==mnuiReporte){
			...
			try {objReporte.setVisible(true);
		...
		if(e.getSource()==btnCotizacionMant){
			...
			try {objCotAutMant.setSelected(true);
			} catch (java.beans.PropertyVetoException e2) {}*/
		}
		...
		if(e.getSource()==mniEditorMensaje){
			...
			try {objEditor.setSelected(true);
			} catch (java.beans.PropertyVetoException e2) {}
		}
