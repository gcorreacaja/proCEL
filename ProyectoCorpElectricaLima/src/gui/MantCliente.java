...
public class MantCliente extends JInternalFrame implements ActionListener, MouseListener, KeyListener {
	...
	EnvioMailsAutoCliente objEnvioMail;
     ...
     String titulo2[]={"COD_CLI","NOM_CLI","TIPO_CLI","LUG_CLI","RUC_CLI","COD_DEP","COD_PRO","COD_DIS","DIR_CLI","CONA_CLI","SEX","TEL1A_CLI","TEL2A_CLI","FAXA_CLI",
			"RPMA_CLI","NEXA_CLI","CELA_CLI","MAILA_CLI","CONB_CLI","TEL1B_CLI","CELB_CLI","MAILB_CLI","RPMB_CLI","NEXB_CLI","COD_TIPO","OBSB_CLI","OBS_CLI","EST_CLI","AGE_CLI"};
	...
	public  MantCliente() {
		...
		try {
			...
			this.setPreferredSize(new java.awt.Dimension(948, 699));
			this.setBounds(0, 0, 948, 699);
			...
			getContentPane().setLayout(null);
			{
				...
				}
				{
					...
					lblPersona.setBounds(354, 95, 63, 14);
				}
				
					txtPersonal = new JTextField();
					jPanel1.add(txtPersonal);
					txtPersonal.setBounds(415, 92, 338, 21);
					...
					scrObservacion.setBounds(93, 182, 789, 38);
					
						txtAObservacion = new JTextArea();
						scrObservacion.setViewportView(txtAObservacion);
						txtAObservacion.setBounds(468, 166, 414, 51);
						txtAObservacion.setPreferredSize(new java.awt.Dimension(771, 34));
					...
					txtEmail.setBounds(341, 155, 541, 21);
					...
					lblSexo.setBounds(756, 95, 34, 14);
					...
					cboSexo.setBounds(790, 92, 90, 21);
	...
	public void listarCliente(){
		...
		String sql="SELECT CLI.COD_CLI, CLI.NOM_CLI, TIPCLI.NOM_TIPO,CLI.LUG_CLI, CLI.RUC_CLI, CLI.COD_DEP, CLI.COD_PRO, CLI.COD_DIS, CLI.DIR_CLI, "+
	       ...
	       " CLI.RPMB_CLI, CLI.NEXB_CLI, TIPCLI.cod_tipo, CLI.OBSB_CLI, CLI.OBS_CLI, CLI.EST_CLI,CLI.AGE_CLI FROM TB_CLIENTE CLI "+
	...
	public void modificarCliente(){
		...
		if(valor==false){
			String sql="UPDATE TB_CLIENTE SET NOM_CLI='"+txtNombreCliente.getText()+"' , " +
				...
				"OBSB_CLI='"+txtAObservacion2.getText()+"' , OBS_CLI='"+dat+"' , AGE_CLI='"+agente+"'   "+
	...
	public void modificarClienteEstado(){
		...
		if(valor==false){
			String sql="UPDATE TB_CLIENTE SET NOM_CLI='"+txtNombreCliente.getText()+"' , " +
				...
				"CELB_CLI='"+txtCelularC.getText()+"' , MAILB_CLI='"+txtEmailC.getText()+"' , "+
				"RPMB_CLI='"+txtRpmC.getText()+"' , NEXB_CLI='"+txtNextelC.getText()+"' , "+
				"OBSB_CLI='"+txtAObservacion2.getText()+"' , OBS_CLI='"+dat+"' , EST_CLI='"+estado+"', AGE_CLI='"+agente+"'  "+
				"WHERE COD_CLI="+codcli+";";
		System.out.println(sql);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==cboLugar){/*c++;if(c==1){listaLugar();}else{}*/}
