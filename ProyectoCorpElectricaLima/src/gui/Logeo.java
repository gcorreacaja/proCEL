...
//		String titulo2[]={"COD_PROD","NOM_PROD","COD_MAR","NOM_MAR","UMED_PROD","OBS_PROD"};
	...
	public void metodosIngresar(){
		...
		}else{System.out.println("ERROR EN LOS DATOS INGRESADOS"+cod);}	
	}
          ...
          " where cod_ven='"+codven+"' ;";
            System.out.println(insertarPregunta);
 			...
 			//System.out.println("ESTO NO KISO GUARDAR:"+guardarCotizacion);
 			   ...
 			   if(op==0){ 
 			     System.out.println("Se actualizo mas de una vez1");
 			   }else{
	...
	/***********************************************************************************************************************************************/
     ...
     class RemindTask extends TimerTask {
		...
		public void run(){
			...
			String hora1=objfec.fechaActual2().trim();
		  ...
		  /*  if(objCot.abrir==1){
			...
			if(objG.COD_VEN==9){
				...
				for(int i=0;i<objenvioMailAuto.tamaño();i++){		
					...
					if(objenvioMailAuto.obtener(i).getFec_pemail().equals(hora1) && objenvioMailAuto.obtener(i).getEst_mail().equals("0")){
					...
					if(objenvioMailAuto.obtener(i).getFec_semail().equals(hora1) && objenvioMailAuto.obtener(i).getEst_mail2().equals("0")){
	         ...
	         /***********************************************************************************************/
				for(int i=0;i<objenvioMailsAutoProv.tamaño();i++){
					...
					if(objenvioMailsAutoProv.obtener(i).getFec_pemail().equals(hora1+".0") && objenvioMailsAutoProv.obtener(i).getEst_mail().equals("0")){
						est=1;
					...
					if(objenvioMailsAutoProv.obtener(i).getFec_semail().equals(hora1+".0") && objenvioMailsAutoProv.obtener(i).getEst_mail2().equals("0")){
						est=1;
						nomvendProv=objenvioMailsAutoProv.obtener(i).getNom_ven();
						nomProv=objenvioMailsAutoProv.obtener(i).getNom_prove();
						sexProv=objenvioMailsAutoProv.obtener(i).getSexprove();
		 ...
		 /*****************************************************************************************************/
		    ...
		    if(hora.equals("6:00:00 PM")){
		        	
		    	//int order=0;
		    	cargarCorreosDeReporte();
				cargarTareasDeReporte(); 
				//order=buscarNumOrden(objG.COD_VEN);
		    ...
		    if(objG.COD_VEN!=9){
			    ...
			    if(nomdia.equals("sáb")){
			    	...
			    	//System.out.println("hola".compareTo("feo"));
			    	 if(hora.equals("6:00:00 PM")){
			    		 objRep=null;
						 objRep=new ReporteSolProve();
						 objRep.setVisible(false);
