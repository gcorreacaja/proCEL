...
public class BeanRepSolProve {
	...
	String cod_sol,cod_cli,nom_cli,cod_ven,nom_ven,ruta_sol,ref_sol,fec_sol,est_llamada,est_envio_mail;
	...
	public BeanRepSolProve(String cod_sol, String cod_cli, String nom_cli,
			...
			String fec_sol, String est_llamada, String est_envio_mail) {
		super();
