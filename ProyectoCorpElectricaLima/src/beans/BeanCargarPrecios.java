...
public class BeanCargarPrecios {
      String descripcion,modelo,cod_prove,cod_mar,cod_umed,cod_rubro,cos_det,mon_det,igv_det;

	public BeanCargarPrecios(String descripcion, String modelo,
			String cod_prove, String cod_mar, String cod_umed,
